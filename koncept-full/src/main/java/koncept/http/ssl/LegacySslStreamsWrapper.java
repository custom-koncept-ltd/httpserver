 ...
 */
/*
 * This code has been modified by custom Koncept Ltd
 * * changing socket channels for sockets, and very simple wrapping logic
 */
package koncept.http.ssl;
...
public class LegacySslStreamsWrapper implements StreamsWrapper {
...
//    ServerImpl server;
    ...
    public LegacySslStreamsWrapper (Socket s, HttpsConfigurator cfg) throws IOException {
        this.s = s;
        this.sslctx = cfg.getSSLContext();
        ...
        wrapper = new EngineWrapper (s, engine);
    }
...
//END_TIGER_EXCLUDE
    ...
    class EngineWrapper {
        ...
        java.io.InputStream s_in;
        java.io.OutputStream s_out;

        EngineWrapper (Socket s, SSLEngine engine) throws IOException {
            this.s = s;
        ...
        WrapperResult wrapAndSendX(ByteBuffer src, boolean ignoreClose) throws IOException {
            ...
            synchronized (wrapLock) {
                ...
                if (r.result.bytesProduced() > 0) {
                    ...
                    while (l>0) {
                    	s_out.write(wrap_dst.get());
                    	l -= 1;
                    	
//                    	wrap_dst.remaining()
//                    	wrap_dst.position();
//                    	if(wrap_dst.hasArray()) {
//                    		s_out.write(b);
//                    	}
//                    	
//                    	
